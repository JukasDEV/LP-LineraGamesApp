import {
  ...
  export const DropboxResetPasswordEmail = ({
    ...
    return (
      <Html>
        <Head />
        <Preview>PlanProBusiness redefinir sua senha</Preview>
        <Body style={main}>
          <Container style={container}>
            ...
            <Section>
              ...
              <Text style={text}>
              Alguém solicitou recentemente uma mudança de senha para a sua conta PlanProBusiness.
              ...
              <Text style={text}>Atenciosamente, Equipe PlanProBusiness</Text>
            </Section>
          </Container>
        </Body>
      </Html>
  ...
  DropboxResetPasswordEmail.PreviewProps = {
    userFirstname: "Alan",
    resetPasswordLink: "https://plan-pro-business.vercel.app",
